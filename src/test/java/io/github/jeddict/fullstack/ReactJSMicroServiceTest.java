...
import io.github.jeddict.client.react.ReactGenerator;
 ...
 * @author jGauravGupta
 */
public class ReactJSMicroServiceTest extends RestApplicationTest {

    @Test
    @Override
    void test() throws Exception {
        Project gatewayProject = generateGateway("reactjs-sample-gateway-app", "emp-job.jpa");
        Project microServiceProject = generateMicroService("reactjs-sample-microservice-app", "emp-job.jpa", gatewayProject);
    ...
    protected TechContext getViewerContext() {
        ...
        TechContext techContext = new TechContext(ReactGenerator.class);
